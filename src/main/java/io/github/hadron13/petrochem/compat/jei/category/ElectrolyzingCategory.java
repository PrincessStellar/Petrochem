...
public class ElectrolyzingCategory extends CreateRecipeCategory<ElectrolyzingRecipe> {
    ...
    public ElectrolyzingCategory(Info<ElectrolyzingRecipe> info) {
        super(info);
    }

    @Override
    protected void setRecipe(IRecipeLayoutBuilder builder, ElectrolyzingRecipe recipe, IFocusGroup focuses) {
    ...
    @Override
    public void draw(ElectrolyzingRecipe recipe, IRecipeSlotsView iRecipeSlotsView, GuiGraphics graphics, double mouseX, double mouseY) {
        ...
        int requiredEnergy = recipe.requiredEnergy;
