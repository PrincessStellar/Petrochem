...
public interface ProcessingRecipeSchema {
    ...
    public static final KubeRecipeFactory ELECTROLYZING_FACTORY = new KubeRecipeFactory(PetrochemRecipeTypes.ELECTROLYZING.id, EnergyProcessingRecipeKube.class, EnergyProcessingRecipeKube::new);
    public static final KubeRecipeFactory PUMPJACK_FACTORY = new KubeRecipeFactory(PetrochemRecipeTypes.PUMPJACK.id, ProcessingRecipeKube.class, ProcessingRecipeKube::new);
    public static final KubeRecipeFactory DISTIL_FACTORY = new KubeRecipeFactory(PetrochemRecipeTypes.DISTILLING.id, TimedProcessingRecipeKube.class, TimedProcessingRecipeKube::new);
